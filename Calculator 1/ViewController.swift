...
//  Calculator 1
//
//  Created by Odd-Henrik Aasen on 24.03.2016.
//  Copyright © 2016 Alonitor Aasen. All rights reserved.
//
...
class ViewController: UIViewController {
	...
	@IBAction func tappedMultiplication(sender: AnyObject) {
	...
	func updateText(){
		guard let labelInt:Int = Int(labelString) else {
			label.text = "Int conversion faild"
			return
		}
